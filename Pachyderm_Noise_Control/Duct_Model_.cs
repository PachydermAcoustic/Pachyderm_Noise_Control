...
//        //            // Use segment midpoint for the duct center
//        //            DuctCenters.Add(prevNode.loc + (currentNode.loc - prevNode.lo
//                List<node> pathNodes = Nodes[i];
//                if (pathNodes.Count < 2) continue;
...
//                    Hare.Geometry.Vector segmentDirection = tangents[j - 1];
//                    if (Hare.Geometry.Hare_math.Dot(segmentDirection, segmentDirection) < epsilon)
//                    {
//                        continue;
//                    }

//                    Hare.Geometry.Vector right = rights[j - 1];
//                    Hare.Geometry.Vector up = ups[j - 1];
...
//                    bool drawStart = j == 1;
//                    bool drawEnd = j == pathNodes.Count - 1;
...
//                            double requiredLength = Math.Max(Math.Abs(w2 - w1), Math.Abs(h2 - h1)) / 2 / maxTransitionTan;
//                            bool needsTaper = segLen > requiredLength && (Math.Abs(w2 - w1) > epsilon || Math.Abs(h2 - h1) > epsilon);

//                            Hare.Geometry.Point[] startProfile = GetRectangleCorners(prevNode.loc, right, up, w1 / 2, h1 / 2);
//                            Hare.Geometry.Point[] endProfile = GetRectangleCorners(currentNode.loc, right, up, w2 / 2, h2 / 2);

//                            if (needsTaper)
//                            {
//                                Hare.Geometry.Point midPoint = prevNode.loc + segmentDirection * requiredLength;
//                                Hare.Geometry.Point[] midProfile = GetRectangleCorners(midPoint, right, up, w2 / 2, h2 / 2);

//                                AddSegmentWalls(DuctWalls, startProfile, midProfile, true, 0, drawStart, false);
//                                AddSegmentWalls(DuctWalls, midProfile, endProfile, true, 0, false, drawEnd);
//                            }
//                            else
//                            {
//                                AddSegmentWalls(DuctWalls, startProfile, endProfile, true, 0, drawStart, drawEnd);
//                            }
//                        }
...
//                            double requiredLength = Math.Abs(d2 - d1) / 2 / maxTransitionTan;
//                            bool needsTaper = segLen > requiredLength && Math.Abs(d2 - d1) > epsilon;

//                            Hare.Geometry.Point[] startProfile = GetCirclePoints(prevNode.loc, right, up, d1 / 2, numSegments);
//                            Hare.Geometry.Point[] endProfile = GetCirclePoints(currentNode.loc, right, up, d2 / 2, numSegments);

//                            if (needsTaper)
//                            {
//                                Hare.Geometry.Point midPoint = prevNode.loc + segmentDirection * requiredLength;
//                                Hare.Geometry.Point[] midProfile = GetCirclePoints(midPoint, right, up, d2 / 2, numSegments);

//                                AddSegmentWalls(DuctWalls, startProfile, midProfile, false, numSegments, drawStart, false);
//                                AddSegmentWalls(DuctWalls, midProfile, endProfile, false, numSegments, false, drawEnd);
//                            }
//                            else
//                            {
//                                AddSegmentWalls(DuctWalls, startProfile, endProfile, false, numSegments, drawStart, drawEnd);
//                            }
//                        }
//                    }
...
//                        AddSegmentWalls(DuctWalls, profiles[0], profiles[1], false, numSegments, drawStart, drawEnd);
//                    }
